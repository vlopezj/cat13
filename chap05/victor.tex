     ...
     \begin{itemize}
       \item
         ...
         \begin{tikzpicture}
           ...
           \node (Cop) [below of=Mi] {$\coprod M_i$};
       ...
       \item
         ...
         The limit of this chain is its first element.
       ...
       \item  
         ...
         \begin{tikzpicture}
           ...
           \node (Prod) [below of=Nip] {$\prod N_i$};
           \node (Q) [below of=Ni] {$\left . {\prod N_i} \right \vert _P$};
         ...
         \begin{tikzpicture}
           ...
           \node (N0) {$N_0$};
           \node (N) [below of=N0] {$N$};
           \node (Mi) [right of=N0] {$N_i$};
           \node (Z)  [right of=N0p] {$Z$};

           \draw[<-] (N0p) to node {$id_{N_0}$} (N0);
           \draw[<-,dotted] (Z) to node {$z$} (N);
           \draw[<-] (Z) to node {$z_0$} (N0);
           \draw[<-] (Z) to node {$z_i$} (Mi);
           \draw[<-] (N0) to node {$g_{0,i}$} (Mi);
